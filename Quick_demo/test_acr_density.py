...
def main():
    ...
    # Fixed prompt
    question = "What is the ACR density for this mammograpy image?"
    ...
    # Output results
    print("Start testing")
    with open("output_dmid_acr.csv", "w", newline="") as outf:
    ...
    print("Saved predictions to output_dmid_demo_acr.csv")
